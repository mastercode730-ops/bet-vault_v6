...
export const blogPosts: BlogPost[] = [
  {
    ...
    sections: [
      ...
      { heading: 'Give live odds a minute', body: "Pre-match prices already account for public knowledge. They can't price in a flat pitch playing easier than expected. Watch the first over before playing live." },
  ...
  },
  {
    ...
    excerpt: 'Slow withdrawals are the top complaint about platforms generally. Here is what actually causes the delay, and how to avoid it.',
  ...
  },
  {
    ...
    category: 'Football',
    icon: '⚽',
    title: 'Football, without the fuss',
    ...
    sections: [
      ...
      { heading: 'Over/under goals', body: "Not about who wins — about total goals. A common line is 2.5, and you're picking above or below it." },
